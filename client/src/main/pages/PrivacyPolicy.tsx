	...
	return (
		<div className="origin">
			...
			<div className="container">
				...
				<h1 id="ID">Interpretation and Definitions</h1>
				<h2 id="ID-i">Interpretation</h2>
				<p>
				...
				<ul>
					...
					<li>
						<p>
							...
							&quot;Our&quot; in this Agreement) refers to Groupo Kalinangan INC, 111 Paseo De Roxas Building, Legaspi Street,
							Makaki City.
						</p>
					</li>
					<li>
					...
					<li>
						<p>
							<strong>Website</strong> refers to Memorya, accessible from{" "}
							<a href="https://memorya.herokuapp.com/" rel="external nofollow noopener" target="_blank">
								https://memorya.herokuapp.com/
							</a>
						</p>
					</li>
					<li>
				...
				<h1 id="CUPD">Collecting and Using Your Personal Data</h1>
				<h2 id="CUPD-td">Types of Data Collected</h2>
				<h3>Personal Data</h3>
				<p>
				...
				<ul>
					<li>
						...
						browser to refuse all Cookies or to indicate when a Cookie is being sent. However, if You do not accept Cookies, You may
						not be able to use some parts of our Service. Unless you have adjusted Your browser setting so that it will refuse
					...
					<li>
						...
						collect and store information about Your preferences or Your activity on our Service. Flash Cookies are not managed by
						the same browser settings as those used for Browser Cookies. For more information on how You can delete Flash Cookies,
						please read &quot;
						<a
				...
				<p>
					...
					or mobile device when You go offline, while Session Cookies are deleted as soon as You close Your web browser. You can
				...
				<h2 id="CUPD-u">Use of Your Personal Data</h2>
				...
				<h2 id="CUPD-r">Retention of Your Personal Data</h2>
				<p>
				...
				<h2 id="CUPD-t">Transfer of Your Personal Data</h2>
				<p>
				...
				<h2 id="CUPD-d">Disclosure of Your Personal Data</h2>
				...
				<h2 id="CUPD-s">Security of Your Personal Data</h2>
				<p>
				...
				<h1 id="CP">Children's Privacy</h1>
				<p>
				...
				<h1 id="LOW">Links to Other Websites</h1>
				<p>
				...
				<h1 id="CPP">Changes to this Privacy Policy</h1>
				<p>
				...
				<ul>
					<li>By email: Jawod50@gmail.com</li>
				</ul>
			</div>

			<div className="contents-container">

				{/* This is not yet functional and I don't know why. */}
				non-functional

				<li><a href="#PP">Privacy Policy</a></li>
				<li><a href="#ID">Interpretation and Definitions</a></li>
				<ul>
					<li><a href="#ID-i">Interpretation</a></li>
					<li><a href="#ID-d">Definitions</a></li>
				</ul>
				<li><a href="#CUPD">Collecting and Using your Personal Data</a></li>
				<ul>
					<li><a href="#CUPD-td">Types of Data Collected</a></li>
					<li><a href="#CUPD-u">Use of your Personal Data</a></li>
					<li><a href="#CUPD-r">Retention of your Personal Data</a></li>
					<li><a href="#CUPD-t">Transfer of your Personal Data</a></li>
					<li><a href="#CUPD-d">Disclosure of your Personal Data</a></li>
					<li><a href="#CUPD-s">Security of your Personal Data</a></li>
				</ul>
				<li><a href="#CP">Children's Privacy</a></li>
				<li><a href="#LOW">Links to Other Websites</a></li>
				<li><a href="#CPP">Changes to the Privacy Policy</a></li>
